    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.depr.nests.egg.variables', $egg->id) }}">Variables</a></li>
    ...
    @foreach($egg->variables as $variable)
        <div class="col-sm-6">
            <div class="box">
                ...
                <form action="{{ route('admin.depr.nests.egg.variables.edit', ['egg' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
...
<div class="modal fade" id="newVariableModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.depr.nests.egg.variables', $egg->id) }}" method="POST">
