    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.depr.nodes.view.servers', $node->id) }}">Servers</a></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <table class="table table-hover">
                    ...
                    @foreach($servers as $server)
                        <tr data-server="{{ $server->uuid }}">
                            ...
                            <td><a href="{{ route('admin.depr.users.view', $server->owner_id) }}">{{ $server->user->username }} ({{ $server->user->email }})</a></td>
